...
{
    public class SelectItemModeInfo : IModeInformation
    {
        string Name = "Select Item Mode";
        string menu1 = "";
        string menu2 = "";
        string menu3 = "";
        string menu4 = "";
        ...
        string menu9 = "";
        string menu10 = "";
        string menu11 = "Up - Choose Item";
        string menu12 = "Down - Choose Item";
        string menu13 = "";
        string menu14 = "Esc - Back to Scan Mode";
        string menu15 = "";
        string menu16 = "";
